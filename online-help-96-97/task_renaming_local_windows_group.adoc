...
---
= System Manager - ONTAP 9.7 이전 버전을 사용하여 로컬 Windows 그룹의 이름을 바꿉니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ONTAP System Manager 클래식(ONTAP 9.7 이하에서 사용 가능)을 사용하면 로컬 Windows 그룹의 이름을 변경하여 그룹을 더 쉽게 식별할 수 있습니다.
