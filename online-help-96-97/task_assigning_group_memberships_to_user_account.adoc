...
---
= System Manager - ONTAP 9.7 이하를 사용하여 사용자 계정에 그룹 구성원 자격을 할당합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
사용자가 특정 그룹과 연결된 권한을 가지려면 ONTAP System Manager 클래식(ONTAP 9.7 이하 버전에서 사용 가능)을 사용하여 사용자 계정에 그룹 멤버쉽을 할당할 수 있습니다.
